...
```
cd existing_repo
git remote add origin https://gitlab.com/skdt/aiip/airuntime/runtime_inferencer_java.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/skdt/aiip/airuntime/runtime_inferencer_java/-/settings/integrations)
